...
object AppMarketingByChannel {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val stream = env
      ...
      .filter(!_.behaviour.equals("UNINSTALL"))
      .assignAscendingTimestamps(_.ts)
      .map(r => ((r.channel, r.behaviour), 1L))
      .keyBy(_._1)
  ...
  class MarketingCount extends ProcessWindowFunction[((String, String), Long), (String, Long, Long), (String, String), TimeWindow] {
